(function($) {
	...
	$( window ).on("load",function() {
		...
		$(".custom-main-drop-link").on("click",function() {
			$(this).addClass('active');
			$(".dropdown-menu.service-main-drp-menu").toggleClass('show');
		})
		...
		$(".service-main-drp-menu .submenu-link-2").on("click",function() {
			$('.services-dropdown .submenu-link').removeClass("active");
			$(this).addClass('active');
		...
		$(document).click(function (e) {
			e.stopPropagation();
			var container = $(".services-dropdown");

			if (container.has(e.target).length === 0) {
				$('.services-dropdown .custom-main-drop-link').removeClass("active");
				$('.services-dropdown .submenu-link').removeClass("active");
			  	$('.services-dropdown .dropdown-menu').removeClass("show");
			}
		});
			...
			$.fn.niceSelect = function(method) {
		        ...
		        function create_nice_select($select) {
		            $select.after($('<div></div>')
		                ...
		                .html($select.attr('multiple') ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Поиск..."/></div><ul class="list"></ul>' : '<span class="current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."/></div><ul class="list"></ul>')
		            );
