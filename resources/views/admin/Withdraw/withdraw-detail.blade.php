        ...
        <div class="user-management-inner">
            <ul class="nav nav-pills user-management-tab withdraw-management-tab" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-1-tab" data-bs-toggle="pill" data-bs-target="#pills-1" type="button" role="tab" aria-controls="pills-1" aria-selected="false">Agent Commission</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-4-tab" data-bs-toggle="pill" data-bs-target="#pills-4" type="button" role="tab" aria-controls="pills-4" aria-selected="true">Payment Status</button>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab" tabindex="0">
                    <div class="payment-status-details">
                        <div class="viewdetails-link d-flex align-items-center">
                            <a href="{{route('withdrawList')}}"><i class="fa-solid fa-angle-left"></i>View details</a>
                        </div>
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" value="Martin@gmail.com" readonly>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Contact</label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" class="form-control" value="Alvado Paradorse" readonly>
                                </div>

                                <div class="col-sm-6 form-group">
                                    <label>Commission Amount</label>
                                    <input type="text" class="form-control" value="$ 75,845" readonly>
                                </div>
                            </div>
                        </form>
                    </div>
