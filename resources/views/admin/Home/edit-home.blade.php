    ...
    <div class="user-management-section">
        ...
        <div class="user-management-inner">
            ...
            <div class="home-management-add">
                <form class="max-width-100" id="edit-home-form" action="{{route('homeUpdate')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <select class="form-control nice-select w-100" name="category_id" id="category_id">
                                ...
                                @foreach($menus as $menu)
                                    <option value="{{$menu->id}}" data-image-size="{{$menu->image_size}}" {{$menu->id == $home_menu->category_id  ? 'selected' : ''}}>{{$menu->title}}</option>
                                @endforeach
                            </select>
                            <p id="cat-error"></p>
                        ...
                        <div class="col-sm-4 form-group brochure-full-width-upload  custom-upload">
                            ...
                            <div class="myform">
                                <div class="uploadbox">
                                    <span class="btn_upload"><input type="file" id="imag" title="" class="input-img" accept="image/*"  name="image" data-width="" data-height=""/><img class="preview1 prev"  id="uploadicon1" src="{{asset('/home_menu/'.$home_menu->image) }}" alt="Gallery Add">
   ...
   $(document).ready(function() {
    ...
    $("#category_id").change(function () {
        if ($(this).val() !== "") {
            ...
            if($("#imag").attr("data-width") >  0 && $("#imag").attr("data-height") > 0){
                $("#imag").val("");
                $("#ImgPreview").attr("src", "");
                $('.preview1').removeClass('prev');
                $('.btn-rmv1').removeClass('rmv');
