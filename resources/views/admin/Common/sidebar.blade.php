    ...
    <div class="sidebar-inner">
        ...
        @php
            $activeRoutes = [
                ...
                'hotelbeds' => request()->routeIs('hotelbeds'),
                'paradores' => request()->routeIs('paradores'),
        ...
        <div class="sidebar-menu-list">
            <ul>
                ...
                <li>
                    <a class="{{ $activeRoutes['hotelbeds'] ? 'active' : '' }}"  href="hotel-content-management.html">
                ...
                <li>
                    <a class="{{ $activeRoutes['paradores'] ? 'active' : '' }}"  href="hotel-content-management-paradores.html">
                ...
                <li>
                    <a class="{{ $activeRoutes['role'] ? 'active' : '' }}" href="role-permission.html">
                ...
                <li>
                    <a class="{{ $activeRoutes['support'] ? 'active' : '' }}" href="support.html">
