                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group  custom-upload">
                            ...
                            <div class="myform">
                                <div class="uploadbox">
                                    <span class="btn_upload"><input type="file" id="imag2" title="" class="input-img" accept="application/pdf"/><img id="uploadicon2" src="{{ asset('/assets_admin/images/gallery-add.png')}}" alt="Gallery Add">
