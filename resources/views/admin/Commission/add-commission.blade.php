...
<div class="admin-content-area">
    <div class="commission-management-section user-management-inner">
        ...
        <div class="commission-management-content">
            <form id="commission-form" action="{{route('commissionSubmit')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-4 form-group">
                        ...
                        <select class="form-control nice-select" name="agent_id" id="agent_id">
                    ...
                    <div class="col-sm-4 form-group price-prifix-box">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control input-card-fees" name="commission_amount" id="commission_amount">
                            <span class="price-prifix">$</span>
                        </div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label>Commission Percentage</label>
                        <input id="percentagecommission" type="text" class="form-control input-card-fees" name="commission_percentage">
                    </div>
