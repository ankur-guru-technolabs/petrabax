            ...
            <div class="col-sm-6 user-register-form">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="suite" placeholder="Suite/Apt" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="homenumber" placeholder="Home Number" required>
                    </div>
