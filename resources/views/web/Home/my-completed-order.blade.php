    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 link-text left-link-text">
                <a href="{{route('myBookedOrder')}}">Pending Orders</a>
            </div>
            <div class="col-6 link-text right-link-text text-end ms-auto">
                <a href="{{route('myCompletedOrder')}}"  class="active">Completed Order</a>
            </div>
        </div>
                        ...
                        <div class="pending-button-list-inner button-box-options-inner">
                            <div class="btn-list">
                                <!--<div class="btn-list-inner">
                                    <a class="blink" href="detail-review.html">Review</a>
                                </div>-->
                                <div class="btn-list-inner w-100">
                                    <a class="w-100" target="_blank" href="chat-order.html">Chat</a>
                                </div>
                                <div class="btn-list-inner">
                            ...
                            <div class="total-price-pending text-center">
                                <a href="destination-guides.html" class="tour-guide-btn">Tour Guide</a>
