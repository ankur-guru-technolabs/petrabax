    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 user-register-form">
                <h2>Travel Agents</h2>
                <form id="register-travel-agent-form" action="{{route('registerTravelAgentSubmit')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="secondary_email" placeholder="Secondary Email Address" value="{{ old('secondary_email') }}">
                    ...
                    <div class="form-group">
                        <label>Agency</label>
                        <input type="text" class="form-control" name="agency" placeholder="Agency" value="{{ old('agency') }}">
                        @error('agency')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="arc" placeholder="ARC, IATAN, or CLIA Number" value="{{ old('arc') }}">
                        @error('arc')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="suite" placeholder="Suite or Apartment Number (Optional)" value="{{ old('suite') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="zip_code" placeholder="Zip Code" value="{{ old('zip_code') }}">
                        @error('zip_code')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
